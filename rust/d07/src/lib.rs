...
fn is_valid_line(total: usize, inputs: &[usize]) -> bool {
    let r: u32 = 2;
    for bitstring in 0 .. r.pow((inputs.len() - 1) as u32) {
...
292: 11 6 16 20"#;
    ...
    fn test_is_valid_line() {
        assert_eq!(is_valid_line(190, &[10, 19]), true);
        assert_eq!(is_valid_line(3267, &[81, 40, 27]), true);
        assert_eq!(is_valid_line(83, &[17, 5]), false);
    }
